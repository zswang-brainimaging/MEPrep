...
def init_bold_wf(
    ...
    * :func:`~fmriprep.workflows.bold.confounds.init_carpetplot_wf`
    ...
    ## ZSW
    ## add the original bold file to be used as a source file in data sink later
    ## Made by Dr. ZS Wang
    config.execution.bold_source_file = bold_file
    preDenoising_choice_from_config = config.execution.preDenoising_choice
    preDenoising_choice = preDenoising_choice_from_config
    ### ZSW
...
"""
    ...
    workflow.connect([
        ...
        (bold_fit_wf, bold_native_wf, [
            ...
            ("outputnode.movpar_file", "inputnode.movpar_file"), ### ZSW
        ]),
    ])  # fmt:skip
    ...
    if boldref_out or echos_out:
        ds_bold_native_wf = init_ds_bold_native_wf(
            ...
            preDenoising_choice=preDenoising_choice,  ##ZSW
        ...
        workflow.connect([
            (bold_native_wf, ds_bold_native_wf, [
             ...
             #   ('outputnode.Residualmap', 'inputnode.Residualmap'),   ### ZSW
             #   ('outputnode.Rsquaremap', 'inputnode.Rsquaremap'),   ### ZSW
                ('outputnode.tedana_choice_selected', 'inputnode.tedana_choice_selected'),  ### ZSW
            ]),
        ])  # fmt:skip
...
"""
    ...
    if spaces.get_spaces(nonstandard=False, dim=(3,)):
        carpetplot_wf = init_carpetplot_wf(
            mem_gb=mem_gb['resampled'],
            metadata=all_metadata[0],
            multiecho=multiecho,  ### ZSW
            preDenoising_choice=preDenoising_choice_from_config, ##ZSW
