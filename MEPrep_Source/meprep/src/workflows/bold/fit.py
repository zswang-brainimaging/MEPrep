...
from .meprep_t2s import init_bold_t2s_wf   ##ZSW
...
def init_bold_native_wf(
    ...
    * :py:func:`~fmriprep.workflows.bold.t2s.init_bold_t2s_wf`
    ...
    bold_file_multiecho = bold_file ##ZSW
    ...
    if multiecho:
        ...
        bold_t2s_wf = init_bold_t2s_wf(
            ...
            TR = metadata["RepetitionTime"],  ##ZSW
            bold_source_file = bold_file_multiecho,  ##ZSW
            omp_nthreads=config.nipype.omp_nthreads,
            name='bold_t2smap_wf',
        )
        ...
        workflow.connect([
            (inputnode, bold_t2s_wf, [("movpar_file", "inputnode.movpar_file")]), ### ZSW, movpar_file comes from bold_fit_wf output, for preICA
            ...
            ##    ("outputnode.Residualmap", "Residualmap"),  ##ZSW
            ##    ("outputnode.Rsquaremap", "Rsquaremap"),  ##ZSW
                ("outputnode.tedana_choice_selected", "tedana_choice_selected"), ###ZSW 
            ]),
        ])  # fmt:skip
    else:
