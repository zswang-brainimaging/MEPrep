...
class execution(_Config):
    ...
    ### WZS  ZSW
    """  added by Dr. Zhishun Wang on Dec 16, 2021, Jan 2022, Aug 2022, Aug 2023, March 2024, May 2025 """
    tedana_choice = None  ### to set choice for running tedana
    preDenoising_choice = None  ## to set choice for running preDenoising each echo data
    output_echo2 = None ## to set echo 2 choice for outputting echo 2 data to compare with OC and ME-ICA-denoised OC
     
    bold_source_file = None
