...
def runICA(fslDir, inFile, outDir, melDirIn, mask, dim, TR, preICA_scme=False):
    ...
    melICthrIn = os.path.join(melDirIn, 'melodic_IC_thr.nii.gz')
    ...
    if preICA_scme:
        shutil.copyfile(melICthrIn, melICthr)
    else:
